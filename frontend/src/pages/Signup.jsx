      ...
      <div className="w-full max-w-md">
        <div className="bg-white p-10">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            ...
            <div className="border border-rule p-5 flex flex-col gap-3">
              <p className="text-ink text-[10px] tracking-[0.2em] uppercase font-semibold mb-1">
                Notification Preferences
              </p>
              {[
              ...
              <p className="text-mute text-[10px] leading-relaxed mt-1">
          ...
          <p className="text-mute text-xs text-center mt-8">
            ...
            <Link to={`/login?next=${encodeURIComponent(next)}`} className="text-ink font-bold hover:underline">
              Sign in
            </Link>
          </p>
        </div>
