...
export default function Support() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: 'We partner with brands that prioritize quality over quantity. All garments are made to last, reducing waste from fast fashion. Many of our brands use organic cotton, recycled materials, or low-impact dyes. Packaging is minimal and recyclable.',
    },
  ]
          ...
          <div className="lg:col-span-2">
            ...
            <div className="mt-8 p-6 border border-rule bg-paper">
              ...
              <div className="flex flex-col gap-2">
                <Link to="/shipping" className="text-ink text-sm hover:underline">Shipping Policy</Link>
                <Link to="/returns"  className="text-ink text-sm hover:underline">Returns &amp; Exchanges</Link>
                <Link to="/terms"    className="text-ink text-sm hover:underline">Terms of Service</Link>
                <Link to="/privacy"  className="text-ink text-sm hover:underline">Privacy Policy</Link>
              </div>
            </div>
          </div>
            ...
            <div className="bg-white border border-rule">
              ...
              <form onSubmit={handleSubmit} className="p-6 flex flex-col gap-5">
                <div className="flex flex-col gap-1.5">
                  <label className="text-ink text-[10px] tracking-[0.2em] uppercase font-semibold">Your Name</label>
                  <input
                    required
                    value={formData.name}
                ...
                <div className="flex flex-col gap-1.5">
                  <label className="text-ink text-[10px] tracking-[0.2em] uppercase font-semibold">Email Address</label>
                  <input
                    type="email"
                    required
                ...
                <div className="flex flex-col gap-1.5">
                  <label className="text-ink text-[10px] tracking-[0.2em] uppercase font-semibold">Message</label>
                  <textarea
                    required
            ...
            <div className="mt-6 p-6 border border-rule bg-white">
              ...
              <div className="flex flex-col gap-3">
                <div>
                  ...
                  <a href="mailto:support@dashop.com" className="text-ink text-sm hover:underline">support@dashop.com</a>
                </div>
                <div>
                  <p className="text-mute text-[9px] tracking-[0.15em] uppercase mb-1">Hours</p>
                  <p className="text-ink text-sm">Mon–Fri 9AM–6PM PST</p>
                </div>
              </div>
            </div>
          </aside>
